...
sock.sendMessage(jid, {
   ...
   publisher: '🌟 Eduardo develop (Boruto VK7)',
   description: '@boruto_vk7/baileys'
}, {
   quoted: message
})
```
...
sock.sendMessage(jid, {
   ...
   offerCode: '@boruto_vk7/baileys', // --- Optional
   offerUrl: 'https://www.npmjs.com/package/@boruto_vk7/baileys', // --- Optional
...
sock.sendMessage(jid, {
   ...
   cards: [{
      ...
      offerCode: '@boruto_vk7/baileys',
      offerUrl: 'https://www.npmjs.com/package/@boruto_vk7/baileys',
...
sock.sendMessage(jid, {
   ...
   externalAdReply: {
      ...
      url: 'https://www.npmjs.com/package/@boruto_vk7/baileys' // --- Optional, used for WhatsApp internal thumbnail caching and direct URL
   }
}, {
   quoted: message
})
...
```javascript
// --- Create a new one
sock.newsletterCreate('@boruto_vk7/baileys', '📣 Fresh updates weekly')
...
// --- Update newsletter
sock.newsletterUpdate('1231111111111@newsletter', { name: '@boruto_vk7/baileys' })

// --- Change name
sock.newsletterUpdateName('1231111111111@newsletter', '📦 @boruto_vk7/baileys')
...
const group = sock.groupCreate('@boruto_vk7/baileys', ['628123456789@s.whatsapp.net'])
...
// --- Change name
sock.groupUpdateSubject(jid, '📦 @boruto_vk7/baileys')
...
sock.updateMemberLabel(jid, '@boruto_vk7/baileys')
```
...
const community = await sock.communityCreate('@boruto_vk7/baileys', '📣 Fresh updates weekly')
...
// --- Change name
sock.communityUpdateSubject(jid, '📦 @boruto_vk7/baileys')
...
await sock.updateBusinessProfile({
   ...
   websites: ['https://www.npmjs.com/package/@boruto_vk7/baileys'],
...
👉🏻 [@borutovk7/starseed](https://github.com/borutovk7/starseed#readme)
...
👉🏻 [@borutovk7/starcore](https://www.npmjs.com/package/@borutovk7/starcore)
...
This fork includes additional enhancements and modifications by [Eduardo develop (Boruto VK7)](https://github.com/borutovk7)
