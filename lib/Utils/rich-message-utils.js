...
// Eduh Dev@ 09-04-26 --- Inject buffer into unifiedResponse.data to support proper rendering of rich messages (ex: tables and code blocks)
                ...
                submessages.push({
                    ...
                    inlineEntities: [{
                            ...
                            metadata: {
                                ...
                                reference_url: url,
                                reference_title: linkField.title || 'Acesse o Site!',
