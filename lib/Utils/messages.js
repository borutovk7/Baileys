...
// Eduh Dev@ 31-01-26 --- Extract product message into a standalone function so it can also be reused as the header for interactive messages
const prepareProductMessage = async (message, options) => {
    ...
    // Eduh Dev@ 01-02-26 --- Add product message default value
    const content = {
        ...message,
        product: {
            currencyCode: 'IDR',
 ...
 */
// Eduh Dev@ 21-04-26 --- Enhanced prepareStickerPackMessage
const prepareStickerPackMessage = async (message, options) => {
    ...
    const logger = options.logger;
    // Eduh Dev@ 01-02-26 --- Add caching for sticker pack
...
// Eduh Dev@ 30-01-26 --- Add native flow button helper for interactive message
const prepareNativeFlowButtons = (message) => {
    ...
    // Eduh Dev@ 31-01-26 --- Add offer and options inside interactive message
    ...
    return {
        buttons: correctedField.map(button => {
            ...
            // Eduh Dev@ 12-03-26 --- Add "single_select" shortcut ＼⁠(⁠°⁠o⁠°⁠)⁠／
...
// Eduh Dev@ 06-02-26 --- Validate album message media to avoid bug 👀
...
// Eduh Dev@ 30-01-26 --- Validate carousel cards header to avoid bug 👀
...
export const generateWAMessageContent = async (message, options) => {
    var _a, _b;
    let m = {};
    // Eduh Dev@ 30-01-26 --- Add "raw" boolean to send raw messages directly via generateWAMessage()
    if (hasNonNullishProperty(message, 'raw')) {
        delete message.raw;
        return message;
    }
    // Eduh Dev@ 09-04-26 --- Add support for code block, latex, reels carousel, table with richResponseMessage
        ...
        if (message.poll.toAnnouncementGroup) {
            ...
            // Eduh Dev@ 08-02-26 --- Add quiz message support
    ...
    // Eduh Dev@ 08-02-26 --- Add poll result snapshot message
    ...
    // Eduh Dev@ 08-02-26 --- Add poll update message
    ...
    // Eduh Dev@ 01-02-26 --- Add payment invite message
    ...
    // Eduh Dev@ 01-02-26 --- Add order message
    ...
    // Eduh Dev@ 31-01-26 --- Add support for album messages
    ...
    // Eduh Dev@ 30-01-26 --- Add interactive messages (buttonsMessage, listMessage, interactiveMessage, templateMessage, and carouselMessage)
    if (hasNonNullishProperty(message, 'buttons')) {
        const buttonsMessage = {
            buttons: message.buttons.map(button => {
                // Eduh Dev@ 12-03-26 --- Add "single_select" shortcut!
                const buttonText = button.text || button.buttonText;
    ...
    // Eduh Dev@ 01-02-26 --- Add request payment message
    ...
    // Eduh Dev@ 01-02-26 --- Add invoice message
    ...
    // Eduh Dev@ 31-01-26 --- Add direct externalAdReply access (no need to create contextInfo first)
    ...
    // Eduh Dev@ 31-01-26 --- Add "groupStatus" boolean to set contextInfo.isGroupStatus and wrap message into groupStatusMessageV2
    ...
    // Eduh Dev@ 06-05-26 --- Add "spoiler" boolean to set contextInfo.isSpoiler and wrap message into spoilerMessage
    ...
    // Eduh Dev@ 02-02-26 --- Add "interactiveAsTemplate" boolean to wrap interactiveMessage into templateMessage
    ...
    // Eduh Dev@ 30-01-26 --- Add "ephemeral" boolean to wrap message into ephemeralMessage like "viewOnce"
    ...
    // Eduh Dev@ 03-02-26 --- Add "viewOnceV2" boolean to wrap message into viewOnceMessageV2 like "viewOnce"
    else if (hasOptionalProperty(message, 'viewOnceV2') && !!message.viewOnceV2) {
        m = { viewOnceMessageV2: { message: m } };
        delete message.viewOnceV2;
    }
    // Eduh Dev@ 03-02-26 --- Add "viewOnceV2Extension" boolean to wrap message into viewOnceMessageV2Extension like "viewOnce"
...
export const generateWAMessageFromContent = (jid, message, options) => {
    ...
    // Eduh Dev@ 30-01-26 --- Add deviceListMetadata inside messageContextInfo for private chat
...
export const normalizeMessageContent = (content) => {
    ...
    return content;
    // Eduh Dev@ 03-02-26 --- Add all futureProofMessage into getFutureProofMessage()
