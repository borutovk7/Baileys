...
export const makeMessagesSocket = (config) => {
    ...
    const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, additionalNodes, useUserDevicesCache, useCachedGroupMetadata, addBizAttributes, statusJidList }) => {
        ...
        await authState.keys.transaction(async () => {
            // Eduh Developer & Lia 02-02-26 --- Normalize message first to extract the original message and valid media type
            ...
            if (isNewsletter) {
                ...
                // Eduh Developer & Lia 08-02-26 --- Add "additionalNodes" for newsletter too (⁠っ⁠˘̩⁠╭⁠╮⁠˘̩⁠)⁠っ
                ...
                binaryNodeContent.push({
                    tag: 'plaintext',
                    attrs: extraAttrs, // Eduh Developer & Lia 02-02-26 --- Add extraAttrs to fix media being rejected when sending to newsletter (⁠◠⁠‿⁠◕⁠)
                    content: bytes
                });
                const stanza = {
                    tag: 'message',
            ...
            // Eduh Developer & Lia 02-02-26 --- Add keepInChat, editedMessage, mediaNotifyMessage and pollUpdateMessage
            const isNeedMetaAttrs = innerMessage?.pinInChatMessage || innerMessage?.keepInChatMessage || innerMessage?.reactionMessage;
            // Eduh Developer & Lia 12-05-26 --- Add groupStatusMessage attributes
            ...
            // Eduh Developer & Lia 02-02-26 --- Add native_flow_name to extraAttrs when sending interactiveResponseMessage
            ...
            // Eduh Developer & Lia 30-01-26 --- Add Biz Binary Node to support button messages
    ...
    const getMediaType = (message) => {
        ...
        // Eduh Developer & Lia 02-02-26 --- Add more message type here
    ...
    return {
        ...
        // Eduh Developer & Lia 30-01-26 --- Add support for modifying additionalNodes and additionalAttributes using "options" in sendMessage()
        sendMessage: async (jid, content, options = {}) => {
            const userJid = authState.creds.me.id;
            // Eduh Developer & Lia 13-03-26 --- Add status mentions!
            if (Array.isArray(jid)) {
                ...
                if (isDeleteMsg || isKeepMsg) {
                    ...
                    additionalNodes.push({
                        tag: 'meta',
                        attrs: {
                            // Eduh Developer & Lia 08-02-26 --- Still a hypothesis regarding PollResult ༎ຶ⁠‿⁠༎ຶ
                ...
                // Eduh Developer & Lia 30-01-26 --- Add support for AI label in message when "ai" is true, but works only in private chat
                else if (isAiMsg) {
                ...
                // Eduh Developer & Lia 06-02-26 --- Refactored to reduce high RSS usage (⁠╥⁠﹏⁠╥⁠)
                if ('album' in content) {
                    const { delayMs = 1500 } = options;
